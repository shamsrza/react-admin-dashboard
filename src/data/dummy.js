...
export const EditorData = () => (
  <div>
    <h3>
      The Rich Text Editor is WYSIWYG ("what you see is what you get") editor
      useful to create and edit content, and return the valid HTML markup or
      markdown of the content Key features:
      <ul>
        ...
        <li> - Allows preview of modified content before saving it.</li>
        <li> - Handles images, hyperlinks, video, hyperlinks, uploads, etc.</li>
      </ul>
    </h3>
  </div>
);
