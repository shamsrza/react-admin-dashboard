...
import comPic from "../data/comPic.jpeg";
    ...
    <div className="mt-12">
      ...
      <div className="flex gap-10 m-4 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl">
          ...
          <div
            className="flex justify-between items-center mt-5 border-t-1"
          ...
          >
            ...
            <p className="text-gray-400 text-sm">77 Recent Transactions</p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <div className="flex justify-between items-center mt-5 border-t-1 border-color">
            ...
            <p className="text-gray-400 text-sm"> 51 Recent Transactions</p>
          </div>
        </div>
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <div className="mt-10">
            <img src={comPic} alt="" className="md:w-96 h-50 rounded-lg" />
            <div className="mt-8">
